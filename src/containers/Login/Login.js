    ...
    <div className="login-container">
      {msalInstance ? (
        ...
        <div className="login-with-microsoft">
          <Row>
            <Col sm="8" className="p-0">
              <div className="login-data-section">
                ...
                <h2 className="SH-Bree-Headline headingsColor mb-4"><FormattedMessage id="WelcometoLeadX"/></h2>
                <p className="Siemens-Sans headingsColor mb-4"><FormattedMessage id="loginSentance"/></p>
                          <MicrosoftLogin
          ...
          <img src={loginMicrosoft} alt="loginMicrosoft" className="cursor-pointer"/>
          </MicrosoftLogin>
              </div>
            </Col>
